...
Route::get("/bienesculturales", function(){
    return view("bienesculturales");
});


Route::get('/categoria/buscar', 'CategoriaController@buscar');
Route::get('/categoria/reporte', 'CategoriaController@generarpdf');
Route::get('/biene/buscar', 'BieneController@buscar');
Route::get('/biene/buscarcol', 'BieneController@buscarcol');
...
Auth::routes(['register' => false]); //registrar
//Auth::routes(); 
